...
import 'package:flutter_application_1/Subcategory/CancelledPlaces.dart';
import 'package:flutter_application_1/Subcategory/CompletedPlaces.dart';
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            MyPlacesList(myPlaces: myPlaces),
            CompletedPlaces(mySpace: mySpace),
            CancelledPlaces(Places: Places),
          ],
        ),
      ),
    );
...
class MyPlacesList extends StatelessWidget {
  final List<Map<String, String>> myPlaces;

  const MyPlacesList({Key? key, required this.myPlaces}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: CircleAvatar(
                        radius: 25,
                        backgroundImage:
                            NetworkImage(myPlaces[index]['image']!),
                      ),
                    ),
                  ),
...
List<Map<String, String>> myPlaces = [
  {
